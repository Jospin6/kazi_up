...
export const InputField: React.FC<InputFieldProps> = ({ label, type, name, placeholder, register, errors, className }) => {
    ...
    return <div className="mb-4">
        ...
        <Input {...register(name)} className={type !== "file" ? className : "hidden"} id={name} placeholder={placeholder} type={type} />
